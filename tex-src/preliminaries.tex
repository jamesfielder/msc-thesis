...
In physics we are often interested in understanding the behaviour of a system independent of the
choice of units we have performed measurements with \citet{0143-0807-31-4-019}. Instead, we wish to
...
In order to achieve this we must non-dimensionalise the problem. This non-dimensionalisation gives 
rise to groupings of quantities known as non-dimensional parameters

One such dimensionless grouping we will require considerably in this report will be the Reynolds
number defined as 
